/*************************************************************************
   ...
   V2.0	11/01/2023	K7ILO
      - modified KK4DAS, Dean Souleles version to work on the RPi Pico.
	  - need to modify DEBUG functions if I decide to add them  back.  
...
class IC746 {
  public:
    // The Constructor
    void begin(long baudrate); // Allow baudrate selection
    void check(); // periodic check for serial commands

    // The functions that link the lib with user supplied functions
